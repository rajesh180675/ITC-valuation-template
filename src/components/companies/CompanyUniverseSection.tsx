  ...
  return (
    <div>
      <SectionHeader
        ...
        subtitle="Apply the same DCF, scenarios, Monte Carlo, reverse DCF, relative valuation, DDM and EVA framework to 15 companies spanning FMCG, IT, paints, tobacco, oil & gas, banking, autos, pharma, telecom, infrastructure, NBFC and power utilities - all on the same FY21-FY25 actuals + FY26E-FY32E projection grid."
