...
const TOT_assets_ALIASES = ['total assets', 'total of assets', 'total assets (including', 'assets']
const EQUITY_ALIASES = ['total equity', "shareholders' equity", 'shareholders funds', 'equity', 'total shareholders funds']
const DEBT_ALIASES = ['borrowings', 'total borrowings', 'loans and advances', 'long term borrowings', 'short term borrowings']
const CASH_ALIASES = ['cash and cash equivalents', 'cash and bank balances', 'cash', 'bank balances']
